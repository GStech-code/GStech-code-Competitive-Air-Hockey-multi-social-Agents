...
start_curriculum_training() {
    ...
    echo ""
    echo "  Phase 1: Learn Hitting (vs static opponents)"
    echo "           - Learn to approach and hit the puck"
    echo ""
    echo "  Phase 2: Learn Shooting (vs static opponents)"
    echo "           - Learn to shoot toward goal"
    echo ""
    echo "  Phase 3: Full Game (vs simple AI)"
    echo "           - Master competitive play"
    echo ""
