# ros_mock.py
# Copied from existing file in this repository src/training/ros_mock.py
...
class RosMock:
    ...
    def apply_agent_policies(self, team_a_policies: List, team_b_policies: List):
        self.team_a_policies = team_a_policies
        self.team_b_policies = team_b_policies
